...
const EditProduct = () => {
    ...
    const fetchProduct = async () => {
        try {
            ...
            setFormData({
                ...
                hasWholesale: product.hasWholesale || false,
    ...
    if (loading) {
        return (
            <div className="font-display bg-background-light dark:bg-background-dark text-text-main dark:text-white min-h-screen flex items-center justify-center">
                ...
                <div className="px-4 md:px-10 lg:px-40 flex flex-1 justify-center py-5">
                    <div className="layout-content-container flex flex-col max-w-[960px] flex-1 pb-20">
                        <nav className="flex flex-wrap gap-2 p-4 text-sm">
                            ...
                            <span className="text-text-muted font-medium">/</span>
                            <span className="text-text-main dark:text-white font-medium">Edit Product</span>
                        </nav>

                        <div className="flex flex-wrap justify-between gap-3 p-4 mb-4">
                            <div className="flex min-w-72 flex-col gap-2">
                                <h1 className="text-4xl font-black leading-tight tracking-[-0.033em] text-text-main dark:text-white">Edit Product</h1>
                                <p className="text-text-muted text-base font-normal">Update the product details below.</p>
                            </div>
                        </div>
                        ...
                        <form className="flex flex-col gap-6" onSubmit={handleSave}>
                            ...
                            <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-border-color dark:border-surface-dark overflow-hidden">
                                ...
                                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <label className="flex flex-col w-full">
                                        <span className="text-sm font-medium pb-2">Product Name <span className="text-red-500">*</span></span>
                                        <input
                                            name="name"
                                            value={formData.name}
                                            onChange={handleChange}
                                            className="form-input w-full rounded-lg border border-border-color dark:border-text-muted bg-background-light dark:bg-background-dark h-12 px-4 focus:border-primary focus:ring-1 focus:ring-primary"
                                            required
                                        />
                                    </label>
                                    <label className="flex flex-col w-full">
                                        <span className="text-sm font-medium pb-2">Barcode / SKU</span>
                                        <input
                                            name="barcode"
                                        ...
                                        {!showNewCategory ? (
                                            <div className="flex gap-2">
                                                <select
                                                    ...
                                                    onChange={handleChange}
                                                    className="form-select flex-1 rounded-lg border border-border-color dark:border-text-muted bg-background-light dark:bg-background-dark h-12 px-4 focus:border-primary focus:ring-1 focus:ring-primary"
                                                >
                                            ...
                                            <div className="flex gap-2">
                                                <input
                                                    ...
                                                    className="form-input flex-1 rounded-lg border border-border-color dark:border-text-muted bg-background-light dark:bg-background-dark h-12 px-4 focus:border-primary focus:ring-1 focus:ring-primary"
                                                />
                                                <button
                                                    type="button"
                            ...
                            <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-border-color dark:border-surface-dark overflow-hidden">
                                <div className="px-6 py-4 border-b border-border-color dark:border-surface-dark flex items-center gap-2">
                                    ...
                                    <h3 className="text-lg font-bold">Price & Stock</h3>
                                </div>
                                <div className="p-6">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                        <label className="flex flex-col w-full">
                                            <span className="text-sm font-medium pb-2">Cost Price ($)</span>
                                            <input
                                                name="costPrice"
                                        ...
                                        <label className="flex flex-col w-full">
                                            <span className="text-sm font-medium pb-2">Selling Price ($) <span className="text-red-500">*</span></span>
                                            <input
                                                name="sellingPrice"
                                                value={formData.sellingPrice}
                                                onChange={handleChange}
                                                className="form-input w-full rounded-lg border border-border-color dark:border-text-muted bg-background-light dark:bg-background-dark h-12 px-4 focus:border-primary focus:ring-1 focus:ring-primary font-medium"
                                                required
                                                step="0.01"
                                                type="number"
                                            />
                                        ...
                                        <label className="flex flex-col w-full">
                                            <span className="text-sm font-medium pb-2">Unit</span>
                                            <select
                                                name="unit"
                                                value={formData.unit}
                                                onChange={handleChange}
                                                className="form-select w-full rounded-lg border border-border-color dark:border-text-muted bg-background-light dark:bg-background-dark h-12 px-4 focus:border-primary focus:ring-1 focus:ring-primary"
                                            >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <label className="flex flex-col w-full">
                                            <span className="text-sm font-medium pb-2">Stock</span>
                                            <input
                                                name="stock"
                                        ...
                                        <label className="flex flex-col w-full">
                                            <span className="text-sm font-medium pb-2">Min Stock Alert</span>
                                            <input
                                                name="minStockAlert"
